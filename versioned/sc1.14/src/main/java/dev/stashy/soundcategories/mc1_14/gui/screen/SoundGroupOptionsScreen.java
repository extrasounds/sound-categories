package dev.stashy.soundcategories.mc1_14.gui.screen;
...
public class SoundGroupOptionsScreen extends Screen implements VersionedSoundGroupOptionsScreenWrapper {
    ...
    public SoundGroupOptionsScreen(Screen parent, Object gameOptions, SoundCategory category) {
        super(new TranslatableText(SoundCategories.getOptionsTranslationKey(category)));
        this.parent = parent;
