package dev.stashy.soundcategories.mc1_21_6.gui.screen;
...
public class CustomSoundOptionsScreen extends VersionedSoundOptionsScreen {
    ...
    protected void initList() {
        ...
        this.list.addAll(new SimpleOption<?>[]{this.gameOptions.getMusicFrequency(), this.gameOptions.getShowNowPlayingToast()});
